...
/** Return a new, open block.
 *
 * This is intended to be used during the parsing process,
 * setting more information on the node before adding it
 * with cmark_parser_add_child()
 */
CMARK_EXPORT
